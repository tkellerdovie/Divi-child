			...
			?>
				<div class="logo_container">
					...
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						...
						?>
						<?php if ($trans[3] == 'en'){ $logo = '/wp-content/uploads/paymeLogo.png'; } ?>
						<?php if ($trans[3] == 'es'){ $logo = '/wp-content/uploads/ePayMe-Blue.png';  } ?>
						<?php if ($trans[3] == 'es_pe'){ $logo = '/wp-content/uploads/ePayMe-Blue.png';  } ?>
						<?php if ($trans[3] == 'pt'){ $logo = '/wp-content/uploads/ePayMe-Blue.png';  } ?>
						<img src="<?php echo $logo; ?>" alt="PayMe Logo" id="logo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />
					</a>
				</div>
